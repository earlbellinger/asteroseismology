c Received: from [128.117.64.4] by aauobs; Tue, 4 Sep 90 09:40:52 -0100
c Received: from hao.ucar.edu by ncar.ucar.EDU (5.64/ NCAR Central Post Office 04/10/90)
c         id AA10540; Tue, 4 Sep 90 01:41:37 MDT
c Date: Tue, 4 Sep 90 01:41:31 MDT
c Message-Id: <9009040741.AA20456@hao.hao.ucar.EDU>
c Received: by hao.hao.ucar.EDU (5.61/ NCAR Mail Server 04/10/90)
c         id AA20456; Tue, 4 Sep 90 01:41:31 MDT
c To: jcd@hao.ucar.edu
...
c
      ...
      integer         n          ,m          ,iz   
      dimension       x(m)       ,y(n)       ,z(iz,n)    ,zx1(n)     , 
     1                zxm(n)     ,zy1(m)     ,zyn(m)                 , 
     2                zxym1      ,zxy1n                  ,zp(m,n,3)  , 
     3                temp(1)    
c  
      fxp(t)=exp(max(-87.d0,min(87.d0,t))) 
c  
      mm = m   
      nn = n   
      mm1 = mm-1   
...
c  
  ...
  131 continue 
      ...
      double precision function  surf2 (xx,yy,m,n,x,y,z,iz,zp,
     *  sigma,noder,dzx,dzy)   
c  
c  
