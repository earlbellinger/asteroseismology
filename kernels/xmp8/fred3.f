C     PROGRAM TO SOLVE FREDHOLM EQUATION OF THE THIRD KIND (EIGENVALUE PROBLEM)
C     USING QUADRATURE METHOD
...
C     NONZERO FUNCTION TO SUPPLY INITIAL VALUES FOR EIGENFUNCTION
