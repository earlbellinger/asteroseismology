C     PROGRAM TO CALCULATE MULTIPLE INTEGRALS OVER A HYPER-RECTANGLE IN
C     N DIMENSIONS USING PRODUCT GAUSS FORMULAS OR COMPOSITE MONOMIAL RULES
C     OR MONTE CARLO METHOD OR THE METHOD BASED ON EQUIDISTRIBUTED SEQUENCES
