C     PROGRAM TO CALCULATE WEIGHTS AND ABSCISSAS OF GAUSS-LEGENDRE QUADRATURE FORMULAS
...
C     To calculate weights and abscissas of a Gauss-Legendre quadrature formula
C
