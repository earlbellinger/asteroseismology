C     PROGRAM FOR FINDING REAL ROOTS OF A NONLINEAR EQUATION IN A
C     SPECIFIED INTERVAL.  THE ROOTS ARE LOCATED BY LOOKING FOR SIGN
C     CHANGES IN THE FUNCTION VALUE AT THE SPECIFIED SEARCH STEP. 
C     AFTER THAT SECANT ITERATION OR BRENT'S METHOD IS USED TO CALCULATE
C     THE ROOT.
...
C     THE SEARCH STEP SHOULD BE CHOSEN CAREFULLY, SINCE A PAIR OF
C     CLOSE ROOTS MAY BE MISSED IF THE STEP IS LARGE. SINGULARITIES
C     WHERE THE FUNCTION CHANGES SIGN ARE ALSO LOCATED AS ROOTS.
...
C     LOCATE THE ROOTS BY LOOKING FOR SIGN CHANGES
...
C	THE REQUIRED FUNCTION WHOSE ZERO IS REQUIRED
      F=X-TAN(X)
      END
