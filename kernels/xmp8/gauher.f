C     PROGRAM TO CALCULATE WEIGHTS AND ABSCISSAS OF GAUSS-HERMITE QUADRATURE FORMULAS
...
C     Since the magnitude of terms and the integrals increase with N the absolute
C     error will increase with N. However, since integral vanishes for odd N it
C     is not possible to use relative error. Thus the maximum error printed out
C     at the end will increase with NT.
...
C     To calculate weights and abscissas of a Gauss-Hermite quadrature formula
C
...
C
C     Required routines : GAUSRC, TQL2
