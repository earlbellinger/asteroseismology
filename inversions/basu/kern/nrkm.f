...
c
c
c  next definition should be real*8 on ibm
      implicit real (a-h,o-z)
c  next definition should be real*4 on ibm
      real   ap,ucy,ea,det
      integer v
...
c
     ...
     .  w(ld),w(lh),w(lhd),w(lq),w(lp),w(lg),w(listor),ik,ik2,ik1,
     .  iiik1,lp,iw,kid)
      return
c
