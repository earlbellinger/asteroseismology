...
! ***********************************************************************
      ...
      integer function extras_check_model(id, id_extra)
         ...
         if (s% x_logical_ctrl(1) .and. Lnuc_div_L > s% Lnuc_div_L_zams_limit) then
      ...
      subroutine data_for_extra_history_columns(id, id_extra, n, names, vals, ierr)
         ...
         names(1) = "standard_cgrav"
         vals(1) = standard_cgrav
      ...
      integer function extras_finish_step(id, id_extra)
		 ...
		 ! Here x_ctrl(1) === beta. 
         write(*,*) s% star_age 
         write(*,*) "exp = ", (13.799d9 / (13.799d9 - s% max_age &
			+ s% star_age))**s% x_ctrl(1)
		 standard_cgrav = 6.67408d-8 * (13.799d9 / (13.799d9 - s% max_age &
			+ s% star_age))**s% x_ctrl(1)
         write(*,*) "G_0 = ", standard_cgrav
         write(*,*) " "
