...
%
    ...
    \caption[Seismic parameters of a stellar model]{Calculation of seismic parameters for a stellar model. %
...
%
    \centering
    \includegraphics[width=0.45\linewidth,keepaspectratio,natwidth=251,natheight=300]{importances-hares.pdf}%
...
%
    ...
    \includegraphics[width=0.5\linewidth,keepaspectratio,natwidth=251,natheight=150]{num_tracks-ev.pdf}%
    \includegraphics[width=0.5\linewidth,keepaspectratio,natwidth=251,natheight=150]{num_tracks-dist.pdf}\\
    \includegraphics[width=0.5\linewidth,keepaspectratio,natwidth=251,natheight=150]{num_tracks-diff.pdf}%
...
%
    ...
    \caption[Hare-and-hound results]{Relative differences between the predicted and true values for age (top left), mass (top right), and radius (bottom) as a function of the true values in a hare-and-hound simulation exercise. \vspace*{5mm} %
...
\begin{figure*}
    \centering
    \includegraphics[width=0.452\linewidth,keepaspectratio,natwidth=251,natheight=300]{FeH0_M_D.pdf}%
...
\begin{figure*}
    ...
    \caption[Evaluations of regression accuracy against the number of models per evolutionary track]{%
