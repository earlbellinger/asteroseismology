...
\end{equation}
where $\mathbf{D}$ is a square diagonal matrix with entries \lr{${\mathbf{D}=\text{diag}(d_1, d_2, \ldots d_{N+3})}$}; and $\mathbf{L}$ is a lower unitriangular matrix, i.e.\ a matrix of the form %
\begin{equation} \label{eq:lower-diag}
    \begin{pmatrix}
        1       &   0     & 0      & \cdots & 0 \\[3mm]
        L_{2,1} &   1     & 0      & \cdots & 0 \\[3mm]
