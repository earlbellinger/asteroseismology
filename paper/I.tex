...
\begin{figure*}
    ...
    \caption{Probability densities showing predictions from machine learning of fundamental stellar parameters for 16 Cyg A (red) and B (blue). Relative uncertainties ($\epsilon = \frac{\sigma}{\mu}\cdot 100$, with mean $\mu$ and standard deviation $\sigma$) are shown to the left of each plot. %Where available (i.e.~M, Y$_0$, Z$_0$, and $\tau$), 
