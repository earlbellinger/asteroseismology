...
\tabletypesize{\scriptsize}
\tablecaption{Means and standard deviations for initial conditions -- mass, chemical composition, mixing length, overshoot coefficient, and diffusion factor -- of the KAGES data set inferred via machine learning from their respective temperatures, metallicities, and asteroseismic observables $\langle \Delta\nu_0 \rangle$, $\langle \delta\nu_{0,2} \rangle$, $\langle r_{0,2} \rangle$, $\langle r_{0,1} \rangle$, and $\langle r_{1,0} \rangle$. \label{tab:results-kages}}
\tablewidth{0pt}
...
\begin{figure*}
    \centering
    \includegraphics[width=0.5\textwidth,keepaspectratio]{figs/evaluation/num_points.pdf}\hfill
    \includegraphics[width=0.5\textwidth,keepaspectratio]{figs/evaluation/num_trees.pdf}
