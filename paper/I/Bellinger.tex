...
\documentclass[manuscript,linenumbers]{aastex6}
...
%Such methods furthermore depend on the choices in physics used to construct models and the uncertainties therein \citep{2014AA...569A..21L} and require new models to be run every time 
...
\begin{figure*}
    \centering
    \includegraphics[width=\linewidth,keepaspectratio,natwidth=652,natheight=390]{inputs.pdf}
...
\begin{figure*}
    \centering
    \includegraphics[width=0.5\linewidth,keepaspectratio,natwidth=251,natheight=150]{solar-test-Dnu0.pdf}\hfill
    \includegraphics[width=0.5\linewidth,keepaspectratio,natwidth=251,natheight=150]{solar-test-dnu02.pdf}\\
    \includegraphics[width=0.5\linewidth,keepaspectratio,natwidth=251,natheight=150]{solar-test-r02.pdf}\hfill
    \includegraphics[width=0.5\linewidth,keepaspectratio,natwidth=251,natheight=150]{solar-test-r01.pdf}\\
...
\begin{figure}
    \centering
    \includegraphics[width=\colwidth, keepaspectratio,natwidth=251,natheight=300]{importances-perturb.pdf}
...
%\begin{figure*}
%    \centering
%    \includegraphics[width=\linewidth, keepaspectratio]{cov-perturb.pdf}
...
\begin{figure*}[!hbtp]
    \centering
    \includegraphics[width=0.5\linewidth,keepaspectratio,natwidth=251,natheight=300]{importances-hares.pdf}\hfill
    \includegraphics[width=0.5\linewidth, keepaspectratio,natwidth=251,natheight=300]{importances-kages.pdf}
...
\begin{figure*}
    \centering
    \includegraphics[width=0.5\linewidth,keepaspectratio,natwidth=3060,natheight=138]{legend.png}\\
...
\begin{figure}
    ...
    \includegraphics[width=\colwidth,keepaspectratio,natwidth=251,natheight=150]{basu-Age-rel.pdf}\\
    \includegraphics[width=\colwidth,keepaspectratio,natwidth=251,natheight=150]{basu-Mass-rel.pdf}\\
    \includegraphics[width=\colwidth,keepaspectratio,natwidth=251,natheight=150]{basu-Radius-rel.pdf}
...
\begin{figure*}
    \centering
    \includegraphics[width=\colwidth, keepaspectratio,natwidth=251,natheight=150]{cyg-radius.pdf}\\
    \includegraphics[width=\colwidth, keepaspectratio,natwidth=251,natheight=150]{cyg-L.pdf}\\
    \includegraphics[width=\colwidth, keepaspectratio,natwidth=251,natheight=150]{cyg-Y_surf.pdf}
...
\begin{figure*}
    \centering
    \includegraphics[width=0.5\linewidth, keepaspectratio,natwidth=251,natheight=150]{cyg-age.pdf}\hfill
    \includegraphics[width=0.5\linewidth, keepaspectratio,natwidth=251,natheight=150]{cyg-M.pdf}\\
    \includegraphics[width=0.5\linewidth, keepaspectratio,natwidth=251,natheight=150]{cyg-Y.pdf}\hfill
    \includegraphics[width=0.5\linewidth, keepaspectratio,natwidth=251,natheight=150]{cyg-Z.pdf}
...
\begin{figure*}
    \centering
    \includegraphics[width=0.332\linewidth,keepaspectratio,natwidth=167,natheight=167]{kages-logg.pdf}\hfill
    \includegraphics[width=0.332\linewidth,keepaspectratio,natwidth=167,natheight=167]{kages-Radius.pdf}\hfill
    \includegraphics[width=0.332\linewidth,keepaspectratio,natwidth=167,natheight=167]{kages-Luminosity.pdf}\\
    \includegraphics[width=0.332\linewidth,keepaspectratio,natwidth=167,natheight=167]{kages-Mass.pdf}
    \includegraphics[width=0.332\linewidth,keepaspectratio,natwidth=167,natheight=167]{kages-Age.pdf}
...
\begin{figure*}
    \centering
    \includegraphics[width=\linewidth,keepaspectratio,natwidth=502,natheight=300]{diffusion.pdf}
...
\begin{figure*}
    \centering
    \includegraphics[width=0.32\textwidth,keepaspectratio,natwidth=876,natheight=1605]{linear.png}\hfill
    \includegraphics[width=0.32\textwidth,keepaspectratio,natwidth=876,natheight=1605]{random.png}\hfill
    \includegraphics[width=0.32\textwidth,keepaspectratio,natwidth=876,natheight=1605]{quasirandom.png}\\
...
\begin{figure}
    ...
    \includegraphics[width=\colwidth,keepaspectratio,natwidth=251,natheight=150]{discontinuity-1.pdf}\\
    \includegraphics[width=\colwidth,keepaspectratio,natwidth=251,natheight=150]{discontinuity-2.pdf}\\
    \includegraphics[width=\colwidth,keepaspectratio,natwidth=251,natheight=150]{discontinuity-3.pdf}\\
...
\begin{figure*}
    \centering
    \includegraphics[width=0.5\linewidth,keepaspectratio,natwidth=251,natheight=300]{FeH0_M_D.pdf}\hfill
    \includegraphics[width=0.5\linewidth,keepaspectratio,natwidth=251,natheight=300]{Fe_H_M_D.pdf}
...
\begin{figure*}
    \centering
    \includegraphics[width=\linewidth, keepaspectratio,natwidth=502,natheight=117]{nearly-even.pdf}
...
\begin{figure*}
    \centering
    \includegraphics[width=0.5\linewidth,keepaspectratio,natwidth=3060,natheight=138]{legend.png}\\
    \includegraphics[width=0.5\linewidth,keepaspectratio,natwidth=251,natheight=150]{num_points-ev.pdf}%
    \includegraphics[width=0.5\linewidth,keepaspectratio,natwidth=251,natheight=150]{num_points-dist.pdf}\\
    \includegraphics[width=0.5\linewidth,keepaspectratio,natwidth=251,natheight=150]{num_points-diff.pdf}%
    \includegraphics[width=0.5\linewidth,keepaspectratio,natwidth=251,natheight=150]{num_points-sigma.pdf}\\
...
\begin{figure*}
    \centering
    \includegraphics[width=0.5\linewidth,keepaspectratio,natwidth=3060,natheight=138]{legend.png}\\
    \includegraphics[width=0.5\linewidth,keepaspectratio,natwidth=251,natheight=150]{num_trees-ev.pdf}%
    \includegraphics[width=0.5\linewidth,keepaspectratio,natwidth=251,natheight=150]{num_trees-dist.pdf}\\
    \includegraphics[width=0.5\linewidth,keepaspectratio,natwidth=251,natheight=150]{num_trees-diff.pdf}%
    \includegraphics[width=0.5\linewidth,keepaspectratio,natwidth=251,natheight=150]{num_trees-sigma.pdf}\\
...
\bibitem[{{Angelou \& Bellinger et al.}(in
  prep.)}]{main-sequence-stats}
{Angelou \& Bellinger et al.} in prep. 

\bibitem[{{Basu} \& {Antia}(1994)}]{1994MNRAS.269.1137B}
{Basu}, S., \& {Antia}, H.~M. 1994, \mnras, 269, 1137

\bibitem[{{Bazot} {et~al.}(2012){Bazot}, {Bourguignon}, \&
  {Christensen-Dalsgaard}}]{2012MNRAS.427.1847B}
...
\bibitem[{{Brown} {et~al.}(1994){Brown}, {Christensen-Dalsgaard},
  {Weibel-Mihalas}, \& {Gilliland}}]{1994ApJ...427.1013B}
{Brown}, T.~M., {Christensen-Dalsgaard}, J., {Weibel-Mihalas}, B., \&
  {Gilliland}, R.~L. 1994, \apj, 427, 1013

\bibitem[{Burgers(1969)}]{burgers1969flow}
Burgers, J.~M. 1969, Flow equations for composite gases, Tech. rep., DTIC
  Document

\bibitem[{{Campante} {et~al.}(2015){Campante}, {Barclay}, {Swift}, {Huber},
  {Adibekyan}, {Cochran}, {Burke}, {Isaacson}, {Quintana}, {Davies}, {Silva
  Aguirre}, {Ragozzine}, {Riddle}, {Baranec}, {Basu}, {Chaplin},
  {Christensen-Dalsgaard}, {Metcalfe}, {Bedding}, {Handberg}, {Stello},
  {Brewer}, {Hekker}, {Karoff}, {Kolbl}, {Law}, {Lundkvist}, {Miglio}, {Rowe},
  {Santos}, {Van Laerhoven}, {Arentoft}, {Elsworth}, {Fischer}, {Kawaler},
  {Kjeldsen}, {Lund}, {Marcy}, {Sousa}, {Sozzetti}, \&
  {White}}]{2015ApJ...799..170C}
{Campante}, T.~L., {Barclay}, T., {Swift}, J.~J., {et~al.} 2015, \apj, 799, 170

\bibitem[{Chaplin \& Miglio(2013)}]{doi:10.1146/annurev-astro-082812-140938}
Chaplin, W.~J., \& Miglio, A. 2013, Annual Review of Astronomy and
  Astrophysics, 51, 353

\bibitem[{{Chaplin} {et~al.}(2011){Chaplin}, {Kjeldsen},
  {Christensen-Dalsgaard}, {Basu}, {Miglio}, {Appourchaux}, {Bedding},
  {Elsworth}, {Garc{\'{\i}}a}, {Gilliland}, {Girardi}, {Houdek}, {Karoff},
  {Kawaler}, {Metcalfe}, {Molenda-{\.Z}akowicz}, {Monteiro}, {Thompson},
  {Verner}, {Ballot}, {Bonanno}, {Brand{\~a}o}, {Broomhall}, {Bruntt},
  {Campante}, {Corsaro}, {Creevey}, {Do{\u g}an}, {Esch}, {Gai}, {Gaulme},
  {Hale}, {Handberg}, {Hekker}, {Huber}, {Jim{\'e}nez}, {Mathur}, {Mazumdar},
  {Mosser}, {New}, {Pinsonneault}, {Pricopi}, {Quirion}, {R{\'e}gulo},
  {Salabert}, {Serenelli}, {Silva Aguirre}, {Sousa}, {Stello}, {Stevens},
  {Suran}, {Uytterhoeven}, {White}, {Borucki}, {Brown}, {Jenkins}, {Kinemuchi},
  {Van Cleve}, \& {Klaus}}]{2011Sci...332..213C}
{Chaplin}, W.~J., {Kjeldsen}, H., {Christensen-Dalsgaard}, J., {et~al.} 2011,
  Science, 332, 213

\bibitem[{{Chaplin} {et~al.}(2014){Chaplin}, {Basu}, {Huber}, {Serenelli},
  {Casagrande}, {Silva Aguirre}, {Ball}, {Creevey}, {Gizon}, {Handberg},
  {Karoff}, {Lutz}, {Marques}, {Miglio}, {Stello}, {Suran}, {Pricopi},
  {Metcalfe}, {Monteiro}, {Molenda-{\.Z}akowicz}, {Appourchaux},
  {Christensen-Dalsgaard}, {Elsworth}, {Garc{\'{\i}}a}, {Houdek}, {Kjeldsen},
  {Bonanno}, {Campante}, {Corsaro}, {Gaulme}, {Hekker}, {Mathur}, {Mosser},
  {R{\'e}gulo}, \& {Salabert}}]{2014ApJS..210....1C}
{Chaplin}, W.~J., {Basu}, S., {Huber}, D., {et~al.} 2014, \apjs, 210, 1

\bibitem[{{Chiappini} {et~al.}(2015){Chiappini}, {Minchev}, {Anders}, {Brauer},
  {Boeche}, \& {Martig}}]{2015ASSP...39..111C}
{Chiappini}, C., {Minchev}, I., {Anders}, F., {et~al.} 2015, Astrophysics and
  Space Science Proceedings, 39, 111

\bibitem[{{Christensen-Dalsgaard}(2008)}]{2008ApSS.316..113C}
{Christensen-Dalsgaard}, J. 2008, \apss, 316, 113

\bibitem[{{Davies} {et~al.}(2014{\natexlab{a}}){Davies}, {Broomhall},
  {Chaplin}, {Elsworth}, \& {Hale}}]{2014MNRAS.439.2025D}
{Davies}, G.~R., {Broomhall}, A.~M., {Chaplin}, W.~J., {Elsworth}, Y., \&
  {Hale}, S.~J. 2014{\natexlab{a}}, \mnras, 439, 2025

\bibitem[{{Davies} {et~al.}(2014{\natexlab{b}}){Davies}, {Handberg}, {Miglio},
  {Campante}, {Chaplin}, \& {Elsworth}}]{2014MNRAS.445L..94D}
{Davies}, G.~R., {Handberg}, R., {Miglio}, A., {et~al.} 2014{\natexlab{b}},
  \mnras, 445, L94

\bibitem[{{Davies} {et~al.}(2015){Davies}, {Chaplin}, {Farr}, {Garc{\'{\i}}a},
  {Lund}, {Mathis}, {Metcalfe}, {Appourchaux}, {Basu}, {Benomar}, {Campante},
  {Ceillier}, {Elsworth}, {Handberg}, {Salabert}, \&
  {Stello}}]{2015MNRAS.446.2959D}
{Davies}, G.~R., {Chaplin}, W.~J., {Farr}, W.~M., {et~al.} 2015, \mnras, 446,
  2959

\bibitem[{{Davies} {et~al.}(2016){Davies}, {Aguirre}, {Bedding}, {Handberg},
  {Lund}, {Chaplin}, {Huber}, {White}, {Benomar}, {Hekker}, {Basu}, {Campante},
  {Christensen-Dalsgaard}, {Elsworth}, {Karoff}, {Kjeldsen}, {Lundkvist},
  {Metcalfe}, \& {Stello}}]{2016MNRAS.456.2183D}
{Davies}, G.~R., {Aguirre}, V.~S., {Bedding}, T.~R., {et~al.} 2016, \mnras,
  456, 2183

\bibitem[{Delmotte(2014)}]{23145595}
...
\bibitem[{{Demarque} {et~al.}(2008){Demarque}, {Guenther}, {Li}, {Mazumdar}, \&
  {Straka}}]{2008ApSS.316...31D}
{Demarque}, P., {Guenther}, D.~B., {Li}, L.~H., {Mazumdar}, A., \& {Straka},
  C.~W. 2008, \apss, 316, 31

\bibitem[{Deming(1943)}]{deming1943statistical}
Deming, W.~E. 1943, Statistical adjustment of data. (Wiley)

\bibitem[{Dowle {et~al.}(2015)Dowle, Srinivasan, Short, with contributions~from
  R~Saporta, \& Antonyan}]{data.table}
...
\bibitem[{{Gai} {et~al.}(2011){Gai}, {Basu}, {Chaplin}, \&
  {Elsworth}}]{2011ApJ...730...63G}
{Gai}, N., {Basu}, S., {Chaplin}, W.~J., \& {Elsworth}, Y. 2011, \apj, 730, 63

\bibitem[{Geurts {et~al.}(2006)Geurts, Ernst, \&
  Wehenkel}]{geurts2006extremely}
Geurts, P., Ernst, D., \& Wehenkel, L. 2006, Machine learning, 63, 3

\bibitem[{{Gontcharov}(2006)}]{2006AstL...32..759G}
{Gontcharov}, G.~A. 2006, Astronomy Letters, 32, 759

\bibitem[{{Grevesse} \& {Sauval}(1998)}]{1998SSRv...85..161G}
{Grevesse}, N., \& {Sauval}, A.~J. 1998, \ssr, 85, 161

\bibitem[{{Haberreiter} {et~al.}(2008){Haberreiter}, {Schmutz}, \&
  {Kosovichev}}]{2008ApJ...675L..53H}
...
\bibitem[{Hastie {et~al.}(2005)Hastie, Tibshirani, Friedman, \&
...
\bibitem[{{Latham} {et~al.}(2002){Latham}, {Stefanik}, {Torres}, {Davis},
  {Mazeh}, {Carney}, {Laird}, \& {Morse}}]{2002AJ....124.1144L}
{Latham}, D.~W., {Stefanik}, R.~P., {Torres}, G., {et~al.} 2002, \aj, 124, 1144

\bibitem[{{Maldonado} {et~al.}(2013){Maldonado}, {Villaver}, \&
  {Eiroa}}]{2013AA...554A..84M}
...
\bibitem[{{Metcalfe} {et~al.}(2014){Metcalfe}, {Creevey}, {Do{\u g}an},
  ...
  {Salabert}, {Serenelli}, {Stello}, {Steslicki}, {Suran}, {Y{\i}ld{\i}z},
  {Aksoy}, {Elsworth}, {Gruberbauer}, {Guenther}, {Lebreton}, {Molaverdikhani},
  {Pricopi}, {Simoniello}, \& {White}}]{2014ApJS..214...27M}
{Metcalfe}, T.~S., {Creevey}, O.~L., {Do{\u g}an}, G., {et~al.} 2014, \apjs,
  214, 27

\bibitem[{{Miglio} {et~al.}(2013){Miglio}, {Chiappini}, {Morel}, {Barbieri},
  {Chaplin}, {Girardi}, {Montalb{\'a}n}, {Valentini}, {Mosser}, {Baudin},
  {Casagrande}, {Fossati}, {Aguirre}, \& {Baglin}}]{2013MNRAS.429..423M}
{Miglio}, A., {Chiappini}, C., {Morel}, T., {et~al.} 2013, \mnras, 429, 423

\bibitem[{{Mohr} {et~al.}(2015){Mohr}, {Newell}, \&
  {Taylor}}]{2015arXiv150707956M}
{Mohr}, P.~J., {Newell}, D.~B., \& {Taylor}, B.~N. 2015, ArXiv e-prints,
  arXiv:1507.07956

\bibitem[{{Morel} \& {Th{\'e}venin}(2002)}]{2002AA...390..611M}
{Morel}, P., \& {Th{\'e}venin}, F. 2002, \aap, 390, 611

\bibitem[{{Mosser} {et~al.}(2012){Mosser}, {Elsworth}, {Hekker}, {Huber},
  {Kallinger}, {Mathur}, {Belkacem}, {Goupil}, {Samadi}, {Barban}, {Bedding},
  {Chaplin}, {Garc{\'{\i}}a}, {Stello}, {De Ridder}, {Middour}, {Morris}, \&
  {Quintana}}]{2012AA...537A..30M}
{Mosser}, B., {Elsworth}, Y., {Hekker}, S., {et~al.} 2012, \aap, 537, A30

\bibitem[{Neuwirth(2014)}]{RColorBrewer}
Neuwirth, E. 2014, RColorBrewer: ColorBrewer Palettes, r package version 1.1-2

\bibitem[{{Nidever} {et~al.}(2002){Nidever}, {Marcy}, {Butler}, {Fischer}, \&
  {Vogt}}]{2002ApJS..141..503N}
{Nidever}, D.~L., {Marcy}, G.~W., {Butler}, R.~P., {Fischer}, D.~A., \& {Vogt},
  S.~S. 2002, \apjs, 141, 503

\bibitem[{Paxton {et~al.}(2011)Paxton, Bildsten, Dotter, Herwig, Lesaffre, \&
  Timmes}]{Paxton2011}
...
\bibitem[{Pitjeva(2015)}]{pitjeva2015determination}
Pitjeva, E. 2015, Journal of Physical and Chemical Reference Data, 44, 031210

\bibitem[{Pulone \& Scaramella(1997)}]{pulone1997age}
Pulone, L., \& Scaramella, R. 1997, in Neural Nets WIRN VIETRI-96 (Springer),
  231--236

\bibitem[{{Quirion} {et~al.}(2010){Quirion}, {Christensen-Dalsgaard}, \&
  {Arentoft}}]{2010ApJ...725.2176Q}
...
\bibitem[{{Rauer} {et~al.}(2014){Rauer}, {Catala}, {Aerts}, {Appourchaux},
  ...
  {Walton}, {Weingrill}, {Werner}, {Wheatley}, \&
  {Zwintz}}]{2014ExA....38..249R}
{Rauer}, H., {Catala}, C., {Aerts}, C., {et~al.} 2014, Experimental Astronomy,
  38, 249

\bibitem[{{Reese} {et~al.}(2016){Reese}, Chaplin, Davies, Miglio, Antia, Ball,
  Basu, Buldgen, Christensen-Dalsgaard, Coelho, Hekker, Houdek, Lebreton,
  Mazumdar, Metcalfe, Aguirre, Stello, \& Verma.}]{spaceinn}
...
\bibitem[{{Ricker} {et~al.}(2015){Ricker}, {Winn}, {Vanderspek}, {Latham},
  ...
  {Villasenor}}]{2015JATIS...1a4003R}
{Ricker}, G.~R., {Winn}, J.~N., {Vanderspek}, R., {et~al.} 2015, Journal of
  Astronomical Telescopes, Instruments, and Systems, 1, 014003

\bibitem[{Robotham(2015)}]{magicaxis}
Robotham, A. 2015, magicaxis: Pretty Scientific Plotting with Minor-Tick and
  log Minor-Tick Support, r package version 1.9.4

\bibitem[{{Rogers} \& {Nayfonov}(2002)}]{2002ApJ...576.1064R}
{Rogers}, F.~J., \& {Nayfonov}, A. 2002, \apj, 576, 1064

\bibitem[{{Rosenthal} {et~al.}(1999){Rosenthal}, {Christensen-Dalsgaard},
  {Nordlund}, {Stein}, \& {Trampedach}}]{1999AA...351..689R}
{Rosenthal}, C.~S., {Christensen-Dalsgaard}, J., {Nordlund}, {\AA}., {Stein},
  R.~F., \& {Trampedach}, R. 1999, \aap, 351, 689

\bibitem[{{Roxburgh} \& {Vorontsov}(2003)}]{2003AA...411..215R}
{Roxburgh}, I.~W., \& {Vorontsov}, S.~V. 2003, \aap, 411, 215

\bibitem[{Schloerke {et~al.}(2014)Schloerke, Crowley, Cook, Hofmann, Wickham,
  Briatte, Marbach, \& Thoen}]{GGally}
Schloerke, B., Crowley, J., Cook, D., {et~al.} 2014, GGally: Extension to
...
\bibitem[{{Silva Aguirre} {et~al.}(2015){Silva Aguirre}, {Davies}, {Basu},
  ...
  {Kjeldsen}, \& {Lundkvist}}]{2015MNRAS.452.2127S}
{Silva Aguirre}, V., {Davies}, G.~R., {Basu}, S., {et~al.} 2015, \mnras, 452,
  2127

\bibitem[{Sobol(1967)}]{sobol1967distribution}
Sobol, I.~M. 1967, USSR Computational mathematics and mathematical physics, 86

\bibitem[{Therneau(2014)}]{deming}
...
\bibitem[{{Verma} {et~al.}(2016){Verma}, {Hanasoge}, {Bhattacharya}, {Antia},
  \& {Krishnamurthy}}]{2016arXiv160200902V}
{Verma}, K., {Hanasoge}, S., {Bhattacharya}, J., {Antia}, H., \&
  {Krishnamurthy}, G. 2016, ArXiv e-prints, arXiv:1602.00902

\bibitem[{{Verma} {et~al.}(2014){Verma}, {Faria}, {Antia}, {Basu}, {Mazumdar},
  {Monteiro}, {Appourchaux}, {Chaplin}, {Garc{\'{\i}}a}, \&
  {Metcalfe}}]{2014ApJ...790..138V}
...
\bibitem[{{White} {et~al.}(2013){White}, {Huber}, {Maestro}, {Bedding},
  ...
  {Sturmann}, {Sturmann}, {ten Brummelaar}, \& {Turner}}]{2013MNRAS.433.1262W}
