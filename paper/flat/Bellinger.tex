...
%\tabletypesize{\scriptsize}
\tablecaption{Means and standard deviations for predicted current-age stellar \mb{parameters} of the Sun (degraded data) and 16 Cyg A and B. \label{tab:results-ca}}
\tablewidth{0pt}
...
\begin{figure*}
    \centering
    \includegraphics[width=0.66\linewidth,keepaspectratio,natwidth=3526,natheight=138]{legend.png}\\
...
\bibitem[{Bellinger(2016)}]{earl_bellinger_2016_55400}
...
\bibitem[{Mahalanobis(1936)}]{mahalanobis1936generalized}
